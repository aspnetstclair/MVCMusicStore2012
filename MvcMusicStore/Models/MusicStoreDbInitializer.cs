        ...
        protected override void Seed(MusicStoreDBContext context)
        {
           ...
           /* context.Artists.Add(new Artist { Name = "Al Di Meola" });
            ...
            new List<Genre>
            {
                ...
                new Genre { Name = "Pop" },
                new Genre { Name = "Classical" }
            }.ForEach(a => context.Genres.Add(a));
            //Lambda expression: ( a => ) acts as a way to pass a parameter and also filter or perform an action on the parameter as well. Here we are cramming all of the genres collection into the variable a and then adding them to the Genres table.
